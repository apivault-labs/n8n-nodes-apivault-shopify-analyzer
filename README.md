...
No login. Pay-as-you-go, no monthly subscription. The 9-source analysis runs server-side on [Apify](https://www.apify.com?fpr=06e5d2); this node is a thin connector you drive with your own Apify API token.
